...
# Corrigido: 82% RBDT + 18% RPKO
perfil_blend_8218 = calcular_blend(perfil_rbdt, perfil_rpko, 0.82, 0.18)
...
if "Blend 82/18 Palma e Palmiste Natura" in selecionados:
    ...
    st.write("**Blend 82/18 Palma e Palmiste Natura (base: 82% RBDT + 18% RPKO)**")
    st.dataframe(df)
    st.bar_chart(df)
