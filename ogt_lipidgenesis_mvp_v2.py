...
if "Blend 82/18 Palma e Palmiste Natura" in selecionados:
    ...
    st.markdown("**Especificações técnicas alvo:**")
    st.markdown("- Temperatura: 55°–60°C")
    st.markdown("- Índice de Acidez: 0,2")
    st.markdown("- Cor Lovibond (Vermelho 5 1/4): máx 4,0")
    st.markdown("- Umidade: máx 0,20%")
    st.markdown("- Índice de Iodo: 37–45")
    st.markdown("- Índice de Saponificação: 193–213")
